...
.news-title{
    ...
    h3{
        ...
        &:before{
            ...
            background-image: linear-gradient(to right, #f5b461 0%, #fff 50%);
        }  
        &:before{
            left: $lateValue;
            background-image: linear-gradient(to left, #f5b461 0%, #fff 50%);
        }
    }
}
.circle{
    ...
    &::after{
        ...
        display: block;
        position: absolute;
        @include circle($circle-w +$moveValue,#f5b461);
...
.out-border{
    ...
    @include box-shadow(0 0 3px 1px #f5b461);
    z-index: 99;
}
.ns-item{
    position: relative;   
