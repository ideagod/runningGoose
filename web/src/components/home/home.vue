    ...
    data(){
        return{
            ...
            newsSoure:[
                ...
                {id:2,title:'最新科技',imgSrc:'./static/img/home-news-pic3.jpg',
                ...
                {id:3,title:'公司资讯',imgSrc:'./static/img/home-news-pic2.jpg',
                article:`当我还住在她丢掉的那首歌里，怀抱所有音符；当我仍在她丢掉的那本书里面，
                封面封底夹着我所有的白昼与黑夜的时候，阿谷，这个如山间清风，
                拂面朗月的彝族姑娘已经给我发了好多信息。或许，伤悲的基调定性。`
                },
                {id:4,title:'娱乐八卦',imgSrc:'./static/img/home-news-pic4.jpg',
                article:`当我还住在她丢掉的那首歌里，怀抱所有音符；当我仍在她丢掉的那本书里面，
                封面封底夹着我所有的白昼与黑夜的时候，阿谷，这个如山间清风，
                拂面朗月的彝族姑娘已经给我发了好多信息。或许，伤悲的基调定性。`
                }
