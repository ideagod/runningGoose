<template>
	<div class="newOrder">
		<person-title>当前位置 :: 我的订单 >> 创建订单 >>  <em>发布代拿订单</em></person-title>
		<div class="createNewOrder">
			<el-form :model="orderForm" :rules="rules" ref="newOrder" label-position='left' @submit.native.prevent :status-icon='true'
			 label-width="7rem" class="demo-orderForm">
				...
				<el-form-item style='margin-left:0.5rem' label="代取地址 : " prop="remarks">
					<el-input type="textarea" :rows="3" placeholder="请输入内容..." resize='none' v-model="orderForm.remarks" clearable>
					</el-input>
				</el-form-item>
				<el-form-item>
