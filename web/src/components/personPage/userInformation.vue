                    ...
                    <div class="userinfo-cont-left">
                        <div class="cont-left-hedaer">
                            ...
                            <ul class="left-info-list">
                                <li class="info-item"> 
                                    <i class="el-icon-mobile-phone" style='color:#f5b461;'></i>
                                    <span class="title">用户账号 :</span> 
                                    {{userInformation.userId}}
                                </li>
                                <li class="info-item"> 
                                    <i class="el-icon-star-on" style='color:#f5b461;'></i>
                                    <span class="title">用户等级 :</span>
                                    {{userInformation.grade==0?'普通用户':'工作人员'}}
                                </li>
                                <li class="info-item">
                                    <i class="el-icon-phone" style='color:#f5b461;'></i>
                                ...
                                <li class="info-item"> 
                                    <i class="el-icon-time" style='color:#f5b461;'></i>
                    ...
                    <div class="userinfo-cont-right">
                        <template v-if='userInformation.grade==1'>
                          <!--  <h4 class="title" >账号余额</h4>
							...
							<h4 class="title" >工作人员 {{userInformation.userId}}</h4>
							<span class="balance">欢迎您</span>
						</template>
                        <template v-else>
 ...
 $userinfo-cont-w:45rem;
    ...
    .userinfo-cont-right{
        ...
        i.line{
            ...
            height: 0.1rem;
            width: calc(100% - 2rem);
            background-image: linear-gradient(to right, #9ad3bc 0%, #f5b461 100%);
